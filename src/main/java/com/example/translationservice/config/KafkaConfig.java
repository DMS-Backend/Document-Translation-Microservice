...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:translation-service}")
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.translationservice.dto,com.example.hello_world_auth.dto");
